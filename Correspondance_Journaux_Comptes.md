...
"Cegid". Tous les fichiers et l'export d'ElomFacture IA utilisent desormais
...
- Le journal ACH n'a pas de compte de tresorerie fixe : chaque facture
  ...
  determine par ElomFacture IA au moment de la lecture.
...
- Ces comptes doivent deja exister dans le dossier (importes via
  `Comptes_SYSCOHADA_ElomFacture.txt`, format 8 chiffres) avant de les
